...
1. **메인 랜딩페이지 (`/`)**
   ...
   #### Hero 섹션
   - **한 줄 문구 (헤드라인)**: `"오늘 새벽 꿈, 아직도 기억나세요?"`
     - 유저가 방문하는 순간(꿈을 꾼 직후)의 상황에 즉각 공감. 추상적인 슬로건 대신 구체적인 상황 묘사로 이탈율 감소
   - **상세 소개 (서브 카피)**: `"프로이트의 정신분석, 칼 융의 원형 이론, 최신 신경과학 연구를 학습한 AI가 꿈 속 상징과 감정을 분석합니다. 단 3분, 커피 한 잔 값으로 어젯밤 꿈의 진짜 의미를 알아보세요."`
     - 과학적 권위(프로이트·융·신경과학) 강조로 미신 느낌 완전 배제
     - "커피 한 잔 값" 앵커링으로 1,500원 가격에 대한 심리적 저항 제거
     - "3분" 반복 노출로 낮은 시간 비용 인식 유도
